...
- **Support Vector Machine (SVM)** - Binary and multi-class classification
...
### 3. **Transformer Architecture with Numpy**
...
### 5. **YOLOv1 (You Only Look Once)**
   - Real-time object detection
   - Single-stage detector
   - Implementation from scratch

### 6. **Generative Adversarial Networks (GAN)**
   - Simple GAN , DC GAN , WGAN , WDCGAN, WGAN-GP
   - Training dynamics
   - Image generation
